$clientId = Get-AutomationVariable -Name 'client-id' 
$tenantId = Get-AutomationVariable -Name 'tenant-id'  
$readerSPNSecret = Get-AutomationVariable -Name 'readerSPNSecret'  
$emailSender = Get-AutomationVariable -Name 'emailSender' 
